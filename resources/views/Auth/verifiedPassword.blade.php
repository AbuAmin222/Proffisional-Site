     ...
     <section class="confirmation-section">
        <div class="confirmation-container">
            ...
            <div class="confirmation-message">
                <p>لقد أرسلنا رابط اعادة التعببن إلى بريدك الإلكتروني <strong>{{ $email }}</strong>. يرجى التحقق من صندوق الوارد الخاص بك.</p>
                <p>إذا لم تجد البريد الإلكتروني، يرجى التحقق من مجلد الرسائل غير المرغوب فيها أو إعادة إرسال الرابط.</p>
            </div>

            <button class="btn-home">
                <a href="{{ route($guard . '.dashboard') }}" style="color: white; text-decoration: none;">العودة إلى الصفحة الرئيسية</a>
            </button>

            <div class="resend-link">
                لم تصلك الرسالة؟ <a href="{{ route($guard . '.forgetPass') }}">إعادة إرسال رابط التعيين</a>
            </div>
        </div>
    </section>
